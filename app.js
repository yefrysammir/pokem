// ============================================================
// xTYPE CHART (Gen VI+) — Ghost vs Normal = 1x per user spec
// ============================================================
const TC={
...
const PD={
1:{id:1,n:‘Bulbasaur’,t:[‘grass’,‘poison’],mv:[‘Latigo Cepa’,‘Placaje’,‘Ventarrón’],sp:‘https://play.pokemonshowdown.com/sprites/ani/bulbasaur.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/bulbasaur.gif’,bs:{hp:90,atk:118,def:111,spd:80},evo:[2],evLv:16,rar:‘normal’,rs:12,rc:8,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/bulbasaur.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/bulbasaur.gif’,evItem:null,expY:64,goldY:30,mapT:[‘grass’],gender:{hasGender:true,maleChance:87},lvR:[3,12],shinyR:1.2,darkR:99.0},
2:{id:2,n:‘Ivysaur’,t:[‘grass’,‘poison’],mv:[‘Latigo Cepa’,‘Rayo Solar’],sp:‘https://play.pokemonshowdown.com/sprites/ani/ivysaur.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/ivysaur.gif’,bs:{hp:110,atk:132,def:123,spd:90},evo:[3],evLv:32,rar:‘pseudo’,rs:5,rc:5,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/ivysaur.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/ivysaur.gif’,evItem:null,expY:142,goldY:60,mapT:[‘grass’],gender:{hasGender:true,maleChance:87},lvR:[16,28]},
3:{id:3,n:‘Venusaur’,t:[‘grass’,‘poison’],mv:[‘Rayo Solar’,‘Tóxico’],sp:‘https://play.pokemonshowdown.com/sprites/ani/venusaur.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/venusaur.gif’,bs:{hp:160,atk:182,def:153,spd:110},evo:[],evLv:null,rar:‘pseudo’,rs:2,rc:3,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/venusaur.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/venusaur.gif’,evItem:null,expY:236,goldY:120,mapT:[‘grass’],gender:{hasGender:true,maleChance:87},lvR:[32,50]},
4:{id:4,n:‘Charmander’,t:[‘fire’],mv:[‘Ascuas’,‘Arañazo’],sp:‘https://play.pokemonshowdown.com/sprites/ani/charmander.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/charmander.gif’,bs:{hp:78,atk:104,def:78,spd:100},evo:[5],evLv:16,rar:‘normal’,rs:12,rc:8,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/charmander.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/charmander.gif’,evItem:null,expY:62,goldY:30,mapT:[‘fire’],gender:{hasGender:true,maleChance:87},lvR:[3,12]},
5:{id:5,n:‘Charmeleon’,t:[‘fire’],mv:[‘Ascuas’,‘Garra Dragón’],sp:‘https://play.pokemonshowdown.com/sprites/ani/charmeleon.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/charmeleon.gif’,bs:{hp:98,atk:129,def:103,spd:120},evo:[6],evLv:36,rar:‘pseudo’,rs:5,rc:5,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/charmeleon.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/charmeleon.gif’,evItem:null,expY:142,goldY:65,mapT:[‘fire’],gender:{hasGender:true,maleChance:87},lvR:[16,30]},
6:{id:6,n:‘Charizard’,t:[‘fire’,‘flying’],mv:[‘Lanzallamas’,‘Vuelo’],sp:‘https://play.pokemonshowdown.com/sprites/ani/charizard.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/charizard.gif’,bs:{hp:156,atk:223,def:173,spd:150},evo:[],evLv:null,rar:‘pseudo’,rs:2,rc:3,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/charizard.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/charizard.gif’,evItem:null,expY:240,goldY:130,mapT:[‘fire’],gender:{hasGender:true,maleChance:87},lvR:[36,55]},
7:{id:7,n:‘Squirtle’,t:[‘water’],mv:[‘Pistola Agua’,‘Placaje’],sp:‘https://play.pokemonshowdown.com/sprites/ani/squirtle.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/squirtle.gif’,bs:{hp:88,atk:86,def:120,spd:78},evo:[8],evLv:16,rar:‘normal’,rs:12,rc:8,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/squirtle.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/squirtle.gif’,evItem:null,expY:63,goldY:30,mapT:[‘water’],gender:{hasGender:true,maleChance:87},lvR:[3,12]},
8:{id:8,n:‘Wartortle’,t:[‘water’],mv:[‘Pistola Agua’,‘Rayo Burbuja’],sp:‘https://play.pokemonshowdown.com/sprites/ani/wartortle.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/wartortle.gif’,bs:{hp:108,atk:113,def:145,spd:98},evo:[9],evLv:36,rar:‘pseudo’,rs:5,rc:5,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/wartortle.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/wartortle.gif’,evItem:null,expY:142,goldY:65,mapT:[‘water’],gender:{hasGender:true,maleChance:87},lvR:[16,30]},
9:{id:9,n:‘Blastoise’,t:[‘water’],mv:[‘Hidrobomba’,‘Cañón de Agua’],sp:‘https://play.pokemonshowdown.com/sprites/ani/blastoise.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/blastoise.gif’,bs:{hp:158,atk:143,def:195,spd:118},evo:[],evLv:null,rar:‘pseudo’,rs:2,rc:3,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/blastoise.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/blastoise.gif’,evItem:null,expY:239,goldY:130,mapT:[‘water’],gender:{hasGender:true,maleChance:87},lvR:[36,55]},
...
26:{id:26,n:‘Raichu’,t:[‘electric’],mv:[‘Rayo’,‘Trueno’],sp:‘https://play.pokemonshowdown.com/sprites/ani/raichu.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/raichu.gif’,bs:{hp:110,atk:165,def:105,spd:150},evo:[],evLv:null,rar:‘pseudo’,rs:3,rc:4,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/raichu.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/raichu.gif’,evItem:null,expY:218,goldY:90,mapT:[‘electric’],gender:{hasGender:true,maleChance:50},lvR:[25,45]},
52:{id:52,n:‘Meowth’,t:[‘normal’],mv:[‘Arañazo’,‘Golpe Bajo’],sp:‘https://play.pokemonshowdown.com/sprites/ani/meowth.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/meowth.gif’,bs:{hp:80,atk:75,def:60,spd:110},evo:[53],evLv:28,rar:‘normal’,rs:14,rc:10,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/meowth.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/meowth.gif’,evItem:null,expY:58,goldY:35,mapT:[‘normal’],gender:{hasGender:true,maleChance:50},lvR:[5,22]},
53:{id:53,n:‘Persian’,t:[‘normal’],mv:[‘Garra Umbría’,‘Hiperrayo’],sp:‘https://play.pokemonshowdown.com/sprites/ani/persian.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/persian.gif’,bs:{hp:105,atk:110,def:95,spd:145},evo:[],evLv:null,rar:‘pseudo’,rs:4,rc:4,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/persian.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/persian.gif’,evItem:null,expY:154,goldY:75,mapT:[‘normal’],gender:{hasGender:true,maleChance:50},lvR:[28,40]},
94:{id:94,n:‘Gengar’,t:[‘ghost’,‘poison’],mv:[‘Bola Sombra’,‘Hipnosis’],sp:‘https://play.pokemonshowdown.com/sprites/ani/gengar.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/gengar.gif’,bs:{hp:120,atk:204,def:128,spd:178},evo:[],evLv:null,rar:‘especial’,rs:3,rc:4,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/gengar.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/gengar.gif’,evItem:null,expY:225,goldY:115,mapT:[‘ghost’],gender:{hasGender:true,maleChance:50},lvR:[25,50]},
131:{id:131,n:‘Lapras’,t:[‘water’,‘ice’],mv:[‘Canto Helado’,‘Surf’],sp:‘https://play.pokemonshowdown.com/sprites/ani/lapras.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/lapras.gif’,bs:{hp:260,atk:165,def:168,spd:100},evo:[],evLv:null,rar:‘especial’,rs:3,rc:3,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/lapras.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/lapras.gif’,evItem:null,expY:187,goldY:100,mapT:[‘water’],gender:{hasGender:true,maleChance:50},lvR:[30,55]},
143:{id:143,n:‘Snorlax’,t:[‘normal’],mv:[‘Amnesia’,‘Hiperrayo’],sp:‘https://play.pokemonshowdown.com/sprites/ani/snorlax.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/snorlax.gif’,bs:{hp:320,atk:190,def:130,spd:30},evo:[],evLv:null,rar:‘especial’,rs:2,rc:3,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/snorlax.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/snorlax.gif’,evItem:null,expY:189,goldY:105,mapT:[‘normal’],gender:{hasGender:true,maleChance:87},lvR:[30,50]},
144:{id:144,n:‘Articuno’,t:[‘ice’,‘flying’],mv:[‘Ventisca’,‘Ventarrón’],sp:‘https://play.pokemonshowdown.com/sprites/ani/articuno.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/articuno.gif’,bs:{hp:180,atk:198,def:218,spd:130},evo:[],evLv:null,rar:‘legendario’,rs:1,rc:1,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/articuno.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/articuno.gif’,evItem:null,expY:290,goldY:300,mapT:[‘ice’],gender:{hasGender:false,maleChance:0},lvR:[50,70]},
145:{id:145,n:‘Zapdos’,t:[‘electric’,‘flying’],mv:[‘Trueno’,‘Ventarrón’],sp:‘https://play.pokemonshowdown.com/sprites/ani/zapdos.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/zapdos.gif’,bs:{hp:180,atk:232,def:178,spd:158},evo:[],evLv:null,rar:‘legendario’,rs:1,rc:1,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/zapdos.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/zapdos.gif’,evItem:null,expY:290,goldY:300,mapT:[‘electric’],gender:{hasGender:false,maleChance:0},lvR:[50,70]},
146:{id:146,n:‘Moltres’,t:[‘fire’,‘flying’],mv:[‘Lanzallamas’,‘Vuelo’],sp:‘https://play.pokemonshowdown.com/sprites/ani/moltres.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/moltres.gif’,bs:{hp:180,atk:242,def:168,spd:148},evo:[],evLv:null,rar:‘legendario’,rs:1,rc:1,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/moltres.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/moltres.gif’,evItem:null,expY:290,goldY:300,mapT:[‘fire’],gender:{hasGender:false,maleChance:0},lvR:[50,70]},
149:{id:149,n:‘Dragonite’,t:[‘dragon’,‘flying’],mv:[‘Garra Dragón’,‘Hiperrayo’],sp:‘https://play.pokemonshowdown.com/sprites/ani/dragonite.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/dragonite.gif’,bs:{hp:182,atk:263,def:198,spd:158},evo:[],evLv:null,rar:‘pseudo’,rs:1,rc:2,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/dragonite.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/dragonite.gif’,evItem:null,expY:270,goldY:150,mapT:[‘dragon’],gender:{hasGender:true,maleChance:50},lvR:[55,75]},
150:{id:150,n:‘Mewtwo’,t:[‘psychic’],mv:[‘Psíquico’,‘Bola Sombra’],sp:‘https://play.pokemonshowdown.com/sprites/ani/mewtwo.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/mewtwo.gif’,bs:{hp:212,atk:300,def:182,spd:212},evo:[],evLv:null,rar:‘legendario’,rs:1,rc:1,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/mewtwo.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/mewtwo.gif’,evItem:null,expY:340,goldY:500,mapT:[‘psychic’],gender:{hasGender:false,maleChance:0},lvR:[60,80]},
151:{id:151,n:‘Mew’,t:[‘psychic’],mv:[‘Psíquico’,‘Transformación’],sp:‘https://play.pokemonshowdown.com/sprites/ani/mew.gif’,spb:‘https://play.pokemonshowdown.com/sprites/ani-back/mew.gif’,bs:{hp:200,atk:220,def:220,spd:220},evo:[],evLv:null,rar:‘singular’,rs:61,rc:61,shSp:‘https://play.pokemonshowdown.com/sprites/ani-shiny/mew.gif’,shSpb:‘https://play.pokemonshowdown.com/sprites/ani-back-shiny/mew.gif’,evItem:null,expY:340,goldY:600,mapT:[‘psychic’],gender:{hasGender:false,maleChance:0},lvR:[70,100]},
...
// GAME STATE
// ============================================================
const DEFAULT_AVATAR=‘https://play.pokemonshowdown.com/sprites/ani/pikachu.gif’;
...
// Bug1 fix: if Pokémon is transformed use its real (original) pid, not the copied one
const realPid=pkm.transformed?(pkm.originalPid||pkm.pid):pkm.pid;
const b=PD[realPid];if(!b||!b.evo||!b.evo.length||pkm.evoPending||b.evItem)return;
...
// Bug2 fix: preserve evoPending so the evo button stays visible on the card.
// Do NOT call renderCurrent() here — it can desync the screen state when
// the evo prompt fires mid-battle (800ms timer vs 1500ms GS.battle=null).
// The button reappears naturally when the player next visits team/PC.
const ov=document.getElementById(‘evo-ov’);if(ov)ov.style.display=‘none’;
}
function showEvoPrompt(pkm){
const tid=pkm.evoPending;const tb=PD[tid];if(!tb)return;
const ov=document.getElementById(‘evo-ov’);
ov.innerHTML=`<div class="evo-box"><div class="evo-glow"></div> <div style="font-family:'Orbitron',sans-serif;font-size:14px;font-weight:700;color:var(--gold)">Evolución</div> <div class="evo-row"> <img class="evo-spr" src="${getSprite(pkm)}" onerror="this.style.display='none'"> <div class="evo-arrow">→</div> <img class="evo-spr" src="${tb.sp||''}" onerror="this.style.display='none'"> </div> <p style="font-size:13px;text-align:center"><b>${pkm.name}</b> → <b>${tb.n}</b></p> <div class="evo-btns"> <button class="btn-do-evo" onclick="doEvolve('${pkm.uid}')">Evolucionar</button> <button class="btn-skip-evo" onclick="skipEvo('${pkm.uid}')">Ahora no</button> </div></div>`;
...
showOv(‘enc-ov’,`<div class="obox"><div class="otitle"><span class="ms" style="color:var(--gold);font-size:18px">star</span> Caramelo Raro</div> <p style="font-size:11px;color:var(--dim);text-align:center">¿A quién le das el caramelo?</p> ${all.map(p=>`<div class="heal-pick-item" onclick="doRareCandy('${p.uid}',${id})">
...
</div>`).join('')} <button class="ebtn ebtn-flee" onclick="closeOv('enc-ov')"><span class="ms">close</span>Cancelar</button></div>`);
}
...
if(s.variant===‘dark’)ctx.filter=‘invert(1) brightness(0.2)’;
...
const dkSt=s.variant===‘dark’?‘filter:invert(1) brightness(0.2)’:’’;
const sprUrl=s.variant===‘shiny’?b.shSp:b.sp;
const lvR=b.lvR||[3,18];
return`<div class="sov-item ${near?'sov-near':''} ${s.variant==='shiny'?'sov-shiny':s.variant==='dark'?'sov-dark':''}" onclick="onSpawnListClick('${s.uid}')"> <img style="width:34px;height:34px;image-rendering:pixelated;object-fit:contain;flex-shrink:0;${dkSt}" src="${sprUrl}" onerror="this.style.display='none'"> <div style="flex:1;min-width:0;overflow:hidden"> <div style="font-size:11px;font-weight:700;display:flex;align-items:center;gap:3px">${variantLabel(s.variant)}${variantName(b.n,s.variant)}${genderTag(s.gender)}<span style="color:var(--dim);font-size:9px">Lv.${s.lv}</span></div> <div style="display:flex;gap:2px;align-items:center;flex-wrap:wrap">${typeBadges(b.t)}<span style="font-size:9px;color:var(--dim)">Nv.${lvR[0]}-${lvR[1]}</span>${near?'<span style="color:#39ff14;font-size:9px;font-weight:700">CERCA</span>':'<span style="font-size:9px;color:var(--dim)">'+d+'cel</span>'}</div> <div style="height:2px;background:rgba(255,255,255,.1);border-radius:1px;margin-top:2px"><div style="height:100%;width:${pct}%;background:${timerCol};border-radius:1px"></div></div> </div> </div>`;
}).join(’’);
}
...
const CELL*=Math.floor(Math.min(cv.width,cv.height)/GRID);
...
const dkSt=s.variant===‘dark’?‘filter:invert(1) brightness(0.2)’:’’;
const sprUrl=s.variant===‘shiny’?b.shSp:b.sp;
showOv(‘enc-ov’,`<div class="obox"> <div class="otitle">${variantLabel(s.variant)} ${variantName(b.n,s.variant)} ${genderTag(s.gender)} <span style="color:var(--dim);font-size:12px">Lv.${s.lv}</span></div> <img class="enc-sprite" src="${sprUrl}" style="${dkSt}" onerror="this.style.display='none'"> <div style="display:flex;gap:6px;align-items:center;flex-wrap:wrap;justify-content:center">${typeBadges(b.t)} <span style="font-size:11px;font-weight:700;color:${rc.col}">${rc.label}</span></div> <div class="enc-btns"> <button class="ebtn ebtn-catch" onclick="quickCatch('${s.uid}')"><span class="ms" style="font-size:18px">circles</span>Atrapar</button> <button class="ebtn ebtn-fight" onclick="startWild('${s.uid}')"><span class="ms" style="font-size:18px">swords</span>Luchar</button> <button class="ebtn ebtn-flee" onclick="fleeEnc('${s.uid}')"><span class="ms" style="font-size:18px">directions_run</span>Huir</button> </div></div>`);
}
...
showOv(‘enc-ov’,`<div class="obox"><div class="otitle">Elige una Poké Ball</div> <div class="ball-grid">${balls.map(b=>`<div class="ball-item" onclick="doCatch('${uid}',${b.id},${dmgPct})">
<img src="${b.sp}" onerror="this.style.display='none'"><span>${b.n}</span><span class="ball-cnt">x${cntBag(b.id)}</span>
</div>`).join('')}</div> <button class="ebtn ebtn-flee" onclick="closeOv('enc-ov')" style="margin-top:4px"><span class="ms">close</span>Cancelar</button></div>`);
}
...
showOv(‘enc-ov’,`<div class="obox"> <div style="font-size:28px">💔</div> <div class="otitle" style="color:var(--acc)">¡${bs.team[bs.idx].name} fue derrotado!</div> <p style="font-size:12px;color:var(--dim);text-align:center">Elige tu siguiente Pokémon:</p> ${bs.team.map((p,i)=>{ if(p.currentHp<=0)return''; return`<div class="switch-row" onclick="forcedSwitch(${i})">
  ...
  if(it.cat==='revive'){
    ...
    showOv('enc-ov',`<div class="obox"><div class="otitle">¿Revivir a quién? (${it.n})</div>
      ${fainted.map(p=>`<div class="heal-pick-item" onclick="doBattleRevive('${p.uid}',${id})">
        <img src="${getSprite(p)}" style="width:36px;image-rendering:pixelated;filter:invert(1) opacity(.4)" onerror="this.style.display='none'">
...
function syncTeam(){
  ...
  GS.battle.team.forEach((bp,i)=>{if(GS.player.team[i])Object.assign(GS.player.team[i],{
    ...
    evoPending:bp.evoPending,_pendingEvoItemId:bp._pendingEvoItemId,thirdMove:bp.thirdMove,pid:bp.pid,types:bp.types,moves:bp.moves,
...
const eSp=e.variant===‘shiny’?(PD[e.pid]?.shSp||PD[e.pid]?.sp||’’):(PD[e.pid]?.sp||‘https://play.pokemonshowdown.com/sprites/ani/pikachu.gif’);
const pSp=getBack(p);
const expPct=Math.round(p.exp/p.expNext*100);
// FIX 2 — dark filter in battle via style string
const eDark=e.variant===‘dark’?‘filter:invert(1) brightness(0.2)’:’’;
const pDark=p.variant===‘dark’?‘filter:invert(1) brightness(0.2)’:’’;
// FIX 4 — transform tag
...
const dark=p.variant===‘dark’&&p.currentHp>0?‘filter:invert(1) brightness(.2)’:’’;
const faint=p.currentHp<=0?‘filter:invert(1) opacity(.4)’:’’;
const vc=p.variant===‘shiny’?‘hud-slot-shiny’:p.variant===‘dark’?‘hud-slot-dark’:’’;
return`<div class="hud-slot ${vc}" title="${p.nickname||p.name} Lv.${p.lv}${p.currentHp<=0?' [KO]':''}"> <img src="${getSprite(p)}" style="${faint||dark}" onerror="this.style.display='none'"></div>`;
...
const imgSt=isFainted?‘filter:invert(1) opacity(0.4)’:pkm.variant===‘dark’?‘filter:invert(1) brightness(0.2)’:’’;
const evoRef=src===‘team’?`GS.player.team[${idx}]`:`GS.player.pc[${idx}]`;
// Bug2: compute evolution availability
// For level-based pending evos (possibly deferred with Ahora no)
const _evoPending=pkm.evoPending&&(!pkm._pendingEvoItemId||cntBag(pkm._pendingEvoItemId)>0);
// For item-based evos: item in bag, no pending set yet, Pokémon not at max evo
const _evoItemAvail=!pkm.evoPending&&b&&b.evItem&&b.evo&&b.evo.length&&cntBag(b.evItem)>0;
const _canEvoNow=(_evoPending||_evoItemAvail)&&!isFainted;
// onclick: if already pending → prompt; if item-based → trigger _applyEvoItem
const _evoOnclick=_evoPending?`showEvoPrompt(${evoRef})`:`_applyEvoItem(${evoRef},${b?b.evItem:null})`;
...
return`<div class="pkm-card ${isFainted?'fainted':''} ${cardCls}"> <div class="pkm-card-hdr"> <img class="pkm-spr" src="${getSprite(pkm)}" style="${imgSt}" onerror="this.style.display='none'"> <div class="pkm-title"> <div class="pkm-name">${variantLabel(pkm.variant)} ${nameHtml} ${genderTag(pkm.gender)}${pkm.nickname?`<span style="font-size:9px;color:var(--dim);font-style:italic">${pkm.name}</span>`:''}</div> <div class="pkm-lv">Lv.${pkm.lv}${pkm.lv>=100?' <span style="color:var(--gold);font-size:9px">MAX</span>':''}</div> <div style="display:flex;align-items:center;gap:4px;flex-wrap:wrap"> <span class="rtag ${rc.cls}">${rc.label}</span> ${typeBadges(pkm.types||b.t)} ${statusTag(pkm.status)} ${isFainted?`<span class="faint-tag"><span class="ms" style="font-size:11px">heart_broken</span>KO</span>`:''} </div> </div> </div> ${_canEvoNow?`<div class="evo-ready-tag" onclick="${_evoOnclick}">⭐ Puede Evolucionar</div>`:''} <div class="exprow">EXP <div class="exprow-bar"><div class="exprow-fill" style="width:${Math.round(pkm.exp/pkm.expNext*100)}%"></div></div><span style="font-size:9px">${pkm.exp}/${pkm.expNext}</span></div> ${isFainted?`
...
${!isSimple?` <div class="statrow"><span>HP</span><div class="statbar"><div class="statbar-fill" style="width:${pp}%;background:${hpCol(pp)}"></div></div><span>${pkm.currentHp}/${pkm.maxHp}</span></div> <div class="statrow"><span>ATK</span><div class="statbar"><div class="statbar-fill" style="width:${Math.min(100,pkm.atk/3)}%;background:#e74c3c"></div></div><span>${pkm.atk}</span></div> <div class="statrow"><span>DEF</span><div class="statbar"><div class="statbar-fill" style="width:${Math.min(100,pkm.def/3)}%;background:#3498db"></div></div><span>${pkm.def}</span></div> <div class="statrow"><span>VEL</span><div class="statbar"><div class="statbar-fill" style="width:${Math.min(100,pkm.spd/3)}%;background:#f39c12"></div></div><span>${pkm.spd}</span></div> <div class="moves-row">${(pkm.moves||[]).map(m=>`<span class="mtag" style="background:${TCOL[MOVE[m]?.type||'normal']||'#777'}">${m}</span>`).join('')}${pkm.thirdMove?`<span class="mtag mtag-extra" style="background:${TCOL[MOVE[pkm.thirdMove]?.type||'normal']||'#777'}">${pkm.thirdMove}</span>`:''}</div> <div style="display:flex;align-items:center;gap:4px;margin-top:2px">${srcIcon}<span style="font-size:9px;color:var(--dim)">${pkm.capturedAt?formatDate(pkm.capturedAt):''}</span></div>`
...
<div class="card-acts">
${_canEvoNow?`<button class="cact cact-evo" onclick="${_evoOnclick}"><span class="ms" style="font-size:14px">star</span>Evo</button>`:’’}
...
sc.innerHTML=`<div class="sec-hdr"><h2>Tienda</h2><p>${GS.player.gold.toLocaleString()} Oro disponible</p></div> ${cats.map(([cat,label,icon])=>{ const its=Object.values(ITEMS).filter(i=>i.cat===cat);if(!its.length)return''; return`<div class="shop-cat"><h3><span class="ms" style="font-size:16px;color:#f39c12">${icon}</span> ${label}</h3><div class="shop-list">
${its.map(it=>`<div class="shop-item"> <img src="${it.sp||''}" onerror="this.style.display='none'"> <div class="shop-item-info"><span class="shop-item-name">${it.n}</span><span class="shop-item-desc">${it.desc}</span><span class="shop-item-own">En mochila: x${cntBag(it.id)}</span></div> <div class="shop-actions"><span class="shop-price">${it.price>=99999?'∞':it.price.toLocaleString()}G</span> ${it.price<99999?`<button class="btn-buy" onclick="buyItem(${it.id})">Comprar</button>`:''} ${it.sell>0?`<button class="btn-sell-item" onclick="sellItem(${it.id})">Vender ${it.sell}G</button>`:''} </div></div>`).join(’’)}
</div></div>`; }).join('')}`;
}
...
sc.innerHTML=`<div class="sec-hdr"><h2>Inventario</h2><p>${bag.length} tipos de ítems</p></div> ${bag.length?`<div class="inv-grid">${bag.map(it=>`<div class="inv-item"> <img src="${it.sp||''}" onerror="this.style.display='none'"> <span class="inv-item-name">${it.n}</span><span class="inv-item-qty">x${it.qty}</span> <div style="font-size:9px;color:var(--dim);text-align:center;padding:0 4px">${it.desc||''}</div> <div class="inv-item-acts"> ${it.cat==='candy'?`<button class="inv-use-btn" onclick="useRareCandy(${it.id})">Usar</button>`:''} ${it.cat==='evo'?`<button class="inv-use-btn" onclick="useEvoItem(${it.id})">Usar</button>`:''} ${it.cat==='mt'?`<button class="inv-use-btn" onclick="openMTItem(${it.id})">Enseñar</button>`:''} ${it.cat==='held'&&it.id===200?(GS.player.expShareOn?`<button class="inv-use-btn" style="background:rgba(46,204,113,.15);color:var(--green);cursor:not-allowed" disabled>✓ Activado</button>`:`<button class="inv-use-btn" onclick="activateHeld(${it.id})">Activar</button>`):it.cat==='held'?`<button class="inv-use-btn" onclick="activateHeld(${it.id})">Activar</button>`:''} ${it.cat==='heal'?`<button class="inv-use-btn" onclick="useHealFromInv(${it.id})">Usar</button>`:''} ${it.cat==='revive'?`<button class="inv-use-btn" onclick="useReviveFromInv(${it.id})">Revivir</button>`:''} ${it.sell>0?`<button class="inv-sell-btn" onclick="sellItem(${it.id});renderInventory()">Vender</button>`:''} </div></div>`).join(’’)}</div>`:'<div class="empty-state">Tu inventario está vacío.</div>'}`;
}
...
showOv(‘enc-ov’,`<div class="obox"><div class="otitle">¿Usar ${it.n} en quién?</div> ${targets.map(p=>`<div class="heal-pick-item" onclick="doUseHealOnPkm('${p.uid}',${id})">
<img src="${getSprite(p)}" style="width:36px;image-rendering:pixelated" onerror="this.style.display='none'">
...
showOv(‘enc-ov’,`<div class="obox"><div class="otitle">¿Revivir a quién?</div> ${targets.map(p=>`<div class="heal-pick-item" onclick="doUseReviveOnPkm('${p.uid}',${id})">
<img src="${getSprite(p)}" style="width:36px;image-rendering:pixelated;filter:invert(1) opacity(.4)" onerror="this.style.display='none'">
...
showOv(‘enc-ov’,`<div class="obox"><div class="otitle">¿Usar ${it.n} en quién?</div> ${eligible.map(p=>`<div class="heal-pick-item" onclick="closeOv('enc-ov');_applyEvoItem(GS.player.team.find(x=>x.uid==='${p.uid}')||GS.player.pc.find(x=>x.uid==='${p.uid}'),${id})">
<img src="${getSprite(p)}" style="width:36px;image-rendering:pixelated" onerror="this.style.display='none'">
...
const it=ITEMS[+id];if(!it||!cntBag(id))return;
showOv(‘enc-ov’,`<div class="obox"><div class="otitle">¿Enseñar ${it.mv} a quién?</div> ${[...GS.player.team,...GS.player.pc].map(p=>`<div class="heal-pick-item" onclick="doTeachMT(${id},'${p.uid}')">
<img src="${getSprite(p)}" style="width:36px;image-rendering:pixelated" onerror="this.style.display='none'">
...
sc.innerHTML=`<div class="sec-hdr"><h2>Entrenadores</h2><p>Tu nivel máximo: ${maxLv}</p></div> ${Object.entries(TRAINERS).map(([region,data])=>`
...
return`<div class="trainer-card ${t.def?'defeated':''} ${!can?'locked':''}"> <div class="t-icon"><span class="ms" style="font-size:28px;color:var(--gold)">${t.icon}</span></div> <div class="t-info"><span class="t-name">${t.n}</span><span class="t-lv">Nivel mínimo: ${t.minLv}</span> <span class="t-reward">Recompensa: ${t.rew.toLocaleString()}G</span> <div class="t-team">${t.pk.map(pk=>`<span class="t-pkm"><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${pk.id}.png" onerror="this.style.display='none'">Lv.${pk.lv}</span>`).join('')}</div> </div> <div>${t.def?`<span class="def-badge"><span class="ms" style="font-size:16px;color:var(--green)">check_circle</span></span>`:!can?`<span class="lock-badge"><span class="ms" style="font-size:16px">lock</span></span>`:`<button class="fight-btn" onclick="startTrainerBattle('${region}','${t.id}')">Luchar</button>`}</div> </div>`;}).join(’’)}</div></div>`).join('')} ${Object.keys(MAPS).some(k=>MAPS[k].legUn)?`<div class="leg-unlock-msg"><span class="ms">stars</span> Legendarios desbloqueados.</div>`:''}`;
}
...
return`<div class="badges-region"> <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;margin-bottom:8px;color:${rd.col}">${rd.name} <span style="font-size:9px;color:var(--dim)">${cnt}/${rd.trainers.length}</span></div> <div class="badges-flex">${rd.trainers.map(t=>{const won=t.def||GS.player.defeatedTrainers.has(t.id); return`<div class="badge-cell ${won?'badge-earned':'badge-locked'}">
...
sc.innerHTML=` <div class="profile-hero"> <img id="profile-hero-img" src="${av}" onerror="this.src='${DEFAULT_AVATAR}'" alt=""> <div class="profile-hero-overlay"> <div class="profile-hero-name">${GS.player.name}</div> <div style="display:flex;gap:6px"> <button class="prof-hero-btn" onclick="openEditNamePop()" title="Cambiar nombre"><span class="ms" style="font-size:16px">edit</span></button> <button class="prof-hero-btn" onclick="openEditAvatarPop()" title="Cambiar foto"><span class="ms" style="font-size:16px">add_a_photo</span></button> </div> </div> </div> <div style="padding:12px;display:flex;flex-direction:column;gap:12px"> <div class="prof-stats"> <div class="pstat"><span>Oro</span><strong>${GS.player.gold.toLocaleString()}</strong></div> <div class="pstat"><span>Pokémon</span><strong>${total}</strong></div> <div class="pstat"><span>Pasos</span><strong>${(GS.player.steps||0).toLocaleString()}</strong></div> <div class="pstat"><span>Debilitados</span><strong style="color:var(--acc)">${GS.player.deaths||0}</strong></div> <div class="pstat"><span>Gyms</span><strong>${defCnt}/${allT.length}</strong></div> <div class="pstat"><span>Códigos</span><strong>${GS.player.usedCodes.size}</strong></div> <div class="pstat"><span>Mapa</span><strong style="font-size:10px">${MAPS[GS.map.id]?.name||''}</strong></div> <div class="pstat"><span>Inicio</span><strong style="font-size:11px">${formatDate(GS.player.createdAt)||'—'}</strong></div> </div> <div class="gym-medals-section"> <div class="medals-header"> <span class="ms" style="font-size:18px;color:var(--gold)">military_tech</span> <span style="font-family:'Orbitron',sans-serif;font-size:13px;font-weight:700">Medallas de Gym</span> <span class="medals-counter">${defCnt}/${allT.length}</span> </div> ${badgesHTML} </div> <div> <div style="font-size:11px;color:var(--dim);text-transform:uppercase;letter-spacing:.5px;margin-bottom:8px;display:flex;align-items:center;gap:6px"><span class="ms" style="font-size:16px">save</span>Partida</div> <div style="display:flex;gap:8px"> <button class="prof-save-btn" onclick="exportSave()"><span class="ms" style="font-size:14px">download</span>Exportar</button> <button class="prof-save-btn" onclick="importSave()"><span class="ms" style="font-size:14px">upload</span>Importar</button> </div> </div> <div class="danger-zone"><h3><span class="ms" style="font-size:16px">warning</span> Zona de peligro</h3> <button class="danger-btn" onclick="resetGame()"><span class="ms" style="font-size:14px">delete_forever</span>Borrar partida</button> </div> </div>`;
}
...
return`<div class="map-info-pkm"><img src="${b.sp}" style="width:38px;height:38px;image-rendering:pixelated" onerror="this.style.display='none'"> <div><div style="font-size:11px;font-weight:700">${b.n}</div> <div style="font-size:9px;color:var(--dim)">Spawn:${b.rs}% · Shiny:${b.shinyR||'?'}% · Dark:${b.darkR||'?'}%</div> <div style="font-size:9px;color:var(--dim)">Nv.${lvR[0]}-${lvR[1]}</div> ${typeBadges(b.t)}</div></div>`;}).join(’’);
const legHTML=m.leg.length?m.leg.map(pid=>{const b=PD[pid];const un=m.legUn;const lvR=b.lvR||[50,70];
return`<div class="map-info-pkm"><img src="${b.sp}" style="width:38px;height:38px;image-rendering:pixelated;${un?'':'filter:invert(1) opacity(.4)'}" onerror="this.style.display='none'"> <div><div style="font-size:11px;font-weight:700;color:${un?'#d4ac0d':'var(--dim)'}">${un?b.n:'???'}</div> <div style="font-size:9px;color:${un?'var(--gold)':'var(--dim)'}">${un?'Nv.'+lvR[0]+'-'+lvR[1]:'Completa Gyms Kanto'}</div></div></div>`;}).join(’’)
:’<div style="font-size:11px;color:var(--dim)">Sin legendarios aquí.</div>’;
showOv(‘enc-ov’,`<div class="obox" style="max-width:340px"> <div class="otitle"><span class="ms" style="color:${m.col}">explore</span> ${m.name}</div> <div style="width:100%"><div style="font-size:10px;font-weight:700;color:var(--dim);text-transform:uppercase;margin-bottom:6px">Encuentros</div><div class="map-info-list">${poolHTML}</div></div> ${m.leg.length?`<div style="width:100%;margin-top:8px"><div style="font-size:10px;font-weight:700;color:var(--gold);text-transform:uppercase;margin-bottom:6px">Legendarios</div><div class="map-info-list">${legHTML}</div></div>`:’’}
...
if(isNew){
ov.innerHTML=`<div class="intro-box"> <div class="intro-logo">POKEM</div> <div class="intro-sub">Tu aventura te espera</div> <div style="width:100%;display:flex;flex-direction:column;gap:10px;margin-top:4px"> <label class="intro-label">Tu apodo de entrenador</label> <input id="intro-name" class="prof-in" placeholder="Ash Misty Red..." maxlength="20" style="width:100%" onkeydown="validateAlNum(event);stopMapKeys(event)" oninput="this.classList.remove('field-error');stopMapKeys(event)" onfocus="stopMapKeys(event)"> <label class="intro-label">Foto de perfil <span style="color:var(--dim);font-size:10px">(URL opcional)</span></label> <div style="display:flex;justify-content:center;margin:2px 0"><img id="intro-av-prev" src="https://play.pokemonshowdown.com/sprites/ani/pikachu.gif" style="width:56px;height:56px;border-radius:50%;border:2px solid var(--blue);object-fit:cover;image-rendering:pixelated" onerror="this.style.display='none'"></div><div id="starter-req-msg" style="font-size:10px;color:var(--acc);text-align:center;display:none">⚠ Selecciona un Pokémon inicial</div><input id="intro-avatar" class="prof-in" placeholder="URL de foto (opcional)" style="width:100%" onkeydown="stopMapKeys(event)" onfocus="stopMapKeys(event)" oninput="var i=document.getElementById('intro-av-prev');if(i){i.src=this.value||'https://play.pokemonshowdown.com/sprites/ani/pikachu.gif';i.style.display='block'}"> </div> <div style="font-size:12px;color:var(--dim);margin-top:10px;text-align:center">¿Con quién empiezas?</div> <div class="starter-grid"> ${[1,4,7,25].map(pid=>{const b=PD[pid]; return`<div class="starter-opt" id="st-${pid}" onclick="selectStarter(${pid})">
...
</div>`; }).join('')} </div> <button class="intro-start-btn" onclick="startAdventure()"> <span class="ms" style="font-size:20px">circles</span>¡Empezar Aventura! </button> </div>`;
}else{
const av=GS.player.avatar;
ov.innerHTML=`<div class="intro-box" style="max-width:300px;gap:14px"> <div class="intro-logo">POKEM</div> ${av?`<img src="${av}" style="width:90px;height:90px;border-radius:50%;border:3px solid var(--blue);object-fit:cover" onerror="this.style.display='none'">` :`<div style="width:90px;height:90px;border-radius:50%;background:var(--card2);border:3px solid var(--blue);display:flex;align-items:center;justify-content:center"><span class="ms" style="font-size:40px;color:var(--dim)">person</span></div>`} <div style="font-family:'Orbitron',sans-serif;font-size:20px;font-weight:700;color:var(--text);text-align:center">${GS.player.name}</div> <div style="font-size:12px;color:var(--dim);text-align:center"> <span class="ms" style="font-size:13px;vertical-align:middle">directions_walk</span> ${(GS.player.steps||0).toLocaleString()} pasos &nbsp;·&nbsp; <span class="ms" style="font-size:13px;vertical-align:middle">circles</span> ${GS.player.team.length+GS.player.pc.length} Pokémon </div> <button class="intro-start-btn" onclick="continueAdventure()" style="background:linear-gradient(135deg,#1a6fa8,#3498db)"> <span class="ms" style="font-size:20px">play_arrow</span>Continuar Partida </button> </div>`;
}
ov.style.display=‘flex’;
}
